...
const sections = [
  ...
  },
  {
    ...
    video: "https://digitalassets.tesla.com/tesla-contents/video/upload/Cybertruck-No-Paint-No-Chips-Desktop-Mobile-Tablet.mp4",
  ...
  },
  {
    id: "vault",
    label: "Vault",
    heading: "Beyond prepared",
    body: "Haul up to 1,134 kg payload. Tow up to 4,990 kg — the weight of an African elephant. A 6-foot composite bed, on-board air compressor, and power outlets at every corner. No liner required.",
    align: "right" as const,
    bg: "var(--surface-dark)",
    img: `${CDN}/Cybertruck-PLL-Load-Desktop.png`,
    video: "https://digitalassets.tesla.com/tesla-contents/video/upload/Cybertruck-Beyond-Prepared-Desktop.mp4",
